...
export default function ContactFooter() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative mx-auto max-w-6xl px-5 sm:px-6 py-14 sm:py-24 safe-pb">
        <motion.div
        ...
        >
          ...
          <h2 className="mt-4 text-2xl sm:text-5xl font-bold tracking-tight text-white leading-tight">
            Hablemos.
          </h2>
          <p className="mt-5 sm:mt-6 text-gray-400 text-sm sm:text-lg leading-relaxed">
          ...
          {CONTACT_CARDS.map(
            ({ icon: Icon, label, value, href, accent, external }) => (
              <motion.a
                ...
                className="group bg-white/5 hover:bg-white/10 active:bg-white/15 border border-white/10 hover:border-white/20 rounded-2xl sm:rounded-3xl p-5 sm:p-6 transition-all"
              >
                ...
                <div className="mt-4 sm:mt-5">
                  <div className="text-[11px] sm:text-xs font-bold uppercase tracking-widest text-gray-400">
                    {label}
                  </div>
        ...
        <div className="mt-10 sm:mt-16 pt-6 sm:pt-8 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 sm:gap-6">
