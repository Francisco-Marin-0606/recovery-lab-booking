...
export default function AboutSection() {
  return (
    <section
      id="nosotros"
      className="relative py-24 sm:py-28 scroll-mt-20"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            {VALUES.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="group bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-0.5 transition-all"
              >
                <div className="w-11 h-11 rounded-2xl bg-black text-white flex items-center justify-center group-hover:scale-105 transition-transform">
            ...
            <div className="sm:col-span-2 rounded-3xl p-6 sm:p-8 bg-gradient-to-br from-gray-900 to-black text-white shadow-sm">
